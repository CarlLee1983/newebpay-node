...
describe("createNewebPayRouter", () => {
    ...
    describe("POST /payment/create", () => {
        ...
        it("應成功建立支付並回傳參數", () => {
            ...
            expect(mockServiceInstance.payment).toHaveBeenCalledWith("ORDER1", 100, "Item", "test@example.com");
        ...
        it("應處理未知的錯誤", () => {
            mockServiceInstance.payment.mockImplementationOnce(() => { throw new Error("Test Error"); });
            const req = {
                body: {
                    orderId: "ORDER1",
                    amount: 100,
